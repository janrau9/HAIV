...
export async function askSuspect(
  ...
  const systemPrompt = `You are suspect number ${suspectId}, ${suspects[suspectId]}. you are a suspect from murder case. You are being interrogated by a detective. you will give answers based on your characteristics.`;
